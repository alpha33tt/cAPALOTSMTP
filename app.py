...
app.config['MAIL_USE_TLS'] = True  # TLS should be enabled
app.config['MAIL_USE_SSL'] = False

app.config['MAIL_USERNAME'] = os.getenv('MAIL_USERNAME', 'cardonewhite081@gmail.com')  # Use your verified email
app.config['MAIL_PASSWORD'] = os.getenv('MAIL_PASSWORD', 'uyjcowqqgadqbozb')  # Ensure this is an App Password for 2FA enabled accounts
